...
class Camera:
    ...
    def keyboard(self, key, x, y):
        ...
        if key == 'w': self.camera_pos += self.camera_speed * self.camera_front
        if key == 's': self.camera_pos -= self.camera_speed * self.camera_front
        if key == 'a': self.camera_pos -= self.camera_speed * right
        if key == 'd': self.camera_pos += self.camera_speed * right
        if key == 'q': self.camera_pos[1] += self.camera_speed   # sobe
        if key == 'e': self.camera_pos[1] -= self.camera_speed   # desce
